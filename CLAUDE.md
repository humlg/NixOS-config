...
modules/
  ...
  system/
    ...
    amdgpu-hdmi-scdc-fix.nix       # Kernel patch reverting the HDMI SCDC scdc_present gate (upstream 3471b9a31ce3, kernel 7.2) whose companion setter isn't in nixpkgs yet — without it physical HDMI + dock DP→HDMI show "connected" but display nothing on DCN3.5. opt-in via custom.amdgpu-hdmi-scdc-fix.enable — saruman only (see maintenance.md #23)
